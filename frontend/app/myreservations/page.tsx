...
const MyReservationsPage = async () => {
    const reservations = await apiService.get('http://localhost:8000/api/auth/myreservations/')

    return (
        <main className="max-w-[1500px] mx-auto px-6 pb-6">
            <h1 className="my-6 text-2xl text-center text-white bg-airbnb p-4 rounded-lg shadow-md">My reservations</h1>
